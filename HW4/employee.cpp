...
void employee::incAge(int inc) {
	age += inc;
	cout << inc << "Years were added to age." << endl;
}
...
int operator+(employee &emp1, const int add) {
	emp1.age += add;
	return emp1.age;
}	

ostream & operator<<(ostream &out, const employee &emp1) {
	out << emp1.age;
	return out;
}
...
void employee::operator=(const employee &emp1) {
	age = emp1.age;
}
